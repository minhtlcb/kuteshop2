					...
					<div class="row">
						<div class="col-md-3 col-sm-3 col-xs-12">
							<div class="logo logo4">
								...
								<a href="{{url('')}}"><img src="images/home4/logo.png" alt="" /></a>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12">
						...
						<div class="col-md-3 col-sm-3 col-xs-9">
							<div class="check-cart check-cart4">
								...
								<div class="wishlist-box">
									<a href="#" class="wishlist-top-link"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
								</div>
								<!-- End Wishlist -->
								<div class="checkout-box">
									...
									<ul class="list-checkout list-unstyled">
                                        ...
                                        @if(isset($_SESSION['username']))
                                        {
                                        	<li><a href="{{url('logout')}}"><i class="fa fa-sign-in"></i> Checkout</a></li>
                                        }
                                        @else
										<li><a href="{{url('login')}}"><i class="fa fa-key" aria-hidden="true"></i>Sign in</a></li>
										@endif
									</ul>
								</div>
								<!-- End Check Out Box -->
